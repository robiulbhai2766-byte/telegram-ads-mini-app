...
export default function Home() {
  ...
  async function startAd() {
    if (!tg?.initData) {
      setMessage("Telegram authentication data is missing.");
      return;
    }
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        setMessage(
          data.message || "Unable to start advertisement."
        );
        return;
      }
  ...
  async function completeAd() {
    ...
    try {
      ...
      setMessage("Advertisement verification failed.");
    }
  }

  function comingSoon(name) {
    setMessage(`${name} feature is coming soon.`);
  }
    ...
    <main className="page">
      ...
      <header className="topHeader">
        <div className="brand">
          ...
          <div>
            <div className="brandName">Ads Earn</div>
      ...
      <style jsx>{`
        ...
        * {
        ...
        .balanceCard {
          ...
          color: white;
          box-shadow:
            0 10px 28px rgba(40,100,232,.22);
        }
